...
const SignUpPersonalDetails = ({ history, loading, error, dispatchLogin }) => (
                            ...
                            return (
                                <Fragment>
                                    ...
                                    >
                                        ...
                                        <fieldset className="mb-5">
                                            <label className="block text-xs mb-2">Referral code</label>
                                            <Field
                                                placeholder=""
                                                type="text"
                                                id="referralCode"
...
export default connect(mapStateToProps, mapDispatchToProps)(SignUpPersonalDetails);
