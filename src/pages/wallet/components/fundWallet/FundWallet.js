    ...
    return (
        ...
        <form>
            <fieldset className="selectFund w-full">
                ...
                <input placeholder="eg: 20,000" type="text" name="amount" className="block w-full text-xs p-3 border border-gray-400 rounded" />
            </fieldset>
            ...
            <div className="nav-buttons flex justify-center">
                ...
                <button className={` w-40 text-center leading-loose bg-wb-primary wealth-buddy--cta text-white rounded-sm opaque`} >
                    Proceed
                        </button>
