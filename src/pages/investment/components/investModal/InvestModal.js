        ...
        <div className="auth-modal flex flex-col items-center bg-white fadeIn login-fieldset">
          ...
          <div className="flex flex-col items-center mb-0">
            ...
            {/* selecting payment method */}
                      ...
                      {
                        !activeTwo ?
                    <div onClick={()=>{setActiveOne(true);setActiveTwo(false);setCard(true)}} className={`rounded-md  w-11/12 sm:w-8/12 border mt-16 flex flex-row items-center content-center py-4 px-4 ${ activeOne ? "blessed" : "good-time"}`}>
                    <div className={`${activeOne ?"plain-b" : "plain-two"}`}>
                        <div className={`${activeOne ? "plain-inner" : ""}`}/>
                    </div>
                    <label className="ml-4 font-medium text-base" for="payment_method">Use debit card </label><br></br>
                    </div>
                    :""  
                    }
                    ...
                    {/* select two */}
                         ...
                         {
                        !activeOne ?
                    <div onClick={()=>{setActiveTwo(true);setActiveOne(false)}} className={`rounded-md  w-11/12 sm:w-8/12 border mt-2 flex flex-row items-center content-center py-4 px-4 ${ activeTwo ? "blessed" : "good-time"}`}>
                         
                    <div className={`${activeTwo ?"plain-b" : "plain-two"}`}>
                        <div className={`${activeTwo ? "plain-inner" : ""}`}/>
                    </div>
                    <label className="ml-4 font-medium text-base" for="payment_method">Use wallet </label><br></br>
                    </div>
                      : ""  
                      }
              ...
              {/* wallet display text */}
                {
                  activeTwo ?
                  <Fragment>
                <p style={{color:"#999999"}} className="text-xs text-center mt-4 ">You have N320,000,323.34 in your wallet</p>
                <button 
