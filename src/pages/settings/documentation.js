      ...
      <ul className="flex h-full account-content documentation-content fadeIn">
        <li className="doc-upload--card">
          ...
          >
            ...
            <div className="leading-snug">
              ...
              {documents === 1 ? (
                ...
                <p className="font-normal text-gray-300">
                  ...
                  reupload a valid identity card for review.
                </p>
              ) : documents === 4 ? (
                <p className="font-normal color-black">
                  Your Identification Card has successfully been approved.
            ...
            ></span>
            {documentsThree === 1 ? (
              <div class="wealth-buddy--cta bg-wb-primary opaque text-white">
                Awaiting Approval
              </div>
            ) : documentsThree === 2 ? (
              <div class="wealth-buddy--cta bg-wb-primary text-white">
                Approved
              </div>
            ) : (
              <div class="wealth-buddy--cta bg-wb-primary text-white">
          ...
          >
            ...
            <div className="leading-snug">
              ...
              {documentsTwo === 1 ? (
                ...
                <p className="font-normal text-gray-300">
                  Give us the details of your <br />
                  Utility Bill and we'll add <br />
                  it to your profile.
                </p>
              )}
            </div>
