  ...
  const tabsContent = {
    profile: (
      <ProfileTab
        ...
        files={files}
        updateTab={activeId}
        handleTab={handleActive}
        innerTabContent={innerTabsContent}
      />
    ),
      ...
      <div className="profile-right--wrap">
        <div className="settings-fields--wrap">
          <div className="wrapper">
            {updateTab === 1 && (
              <figure className="basic-profile mb-5 flex items-center">
                ...
                <figcaption className="ml-5">
                  ...
                  <p className=" text-sm color-accent">
            ...
            <div
              className={`wealth-buddy--cta bg-wb-primary mt-8 text-white opaque`}
            >
              {" "}
