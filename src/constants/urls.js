const urls = {
  ...
  treatGroupTargetInvitation:
    '/api/GroupTargetSavings/treatgroupsavingsinvitation',
  ...
  treatGroupChallengeInvitation:
    '/api/GroupChallengeSavings/treatgroupsavingsinvitation',
  //Group Contributory Savings
  createGroupContributorySavings:
    '/api/GroupContributorySavings/creategroupsavings',
  getGroupContributorySavingsById:
    '/api/GroupContributorySavings/getgroupsavings/:id',
  startGroupContributorySavings:
    '/api/GroupContributorySavings/startgroupsavings',
  cancelGroupContributorySavings:
    '/api/GroupContributorySavings/cancelgroupsavings',
  treatGroupContributoryInvitation:
    '/api/GroupContributorySavings/treatgroupsavingsinvitation',
  //
