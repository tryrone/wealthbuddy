...
import CreatePersonalTargetSavings from "pages/savings/CreatePersonalTargetSavings";
...
const Savings = () => {
  ...
  return (
    <Switch>
      ...
      <Route path={`${path}/create/personal`} component={CreatePersonalTargetSavings} />
